...
// IUC Tables for 2026 - Passenger Cars Only
export const IUC_TABLES_2026_CARS = {
  categories: {
    // Categoria A: Veículos anteriores a Junho de 2007
    A: {
      baseRates: [
        { minCc: 0, maxCc: 1250, rate: 31.77 },
        { minCc: 1251, maxCc: 1750, rate: 63.74 },
        { minCc: 1751, maxCc: 2500, rate: 127.35 },
        { minCc: 2501, maxCc: Infinity, rate: 435.84 },
      ],
      dieselSurcharge: [
        { minCc: 0, maxCc: 1250, surcharge: 5.02 },
        { minCc: 1251, maxCc: 1750, surcharge: 10.07 },
        { minCc: 1751, maxCc: 2500, surcharge: 20.12 },
        { minCc: 2501, maxCc: Infinity, surcharge: 68.85 },
      ],
      registrationYearCoefficients: [
        { minYear: 2007, maxYear: 2007, coefficient: 1.00 },
        { minYear: 2008, maxYear: 2008, coefficient: 1.05 },
        { minYear: 2009, maxYear: 2009, coefficient: 1.10 },
        { minYear: 2010, maxYear: Infinity, coefficient: 1.15 },
      ],
    },
    ...
    B: {
      ...
      co2RatesNEDC: [
        { minCo2: 0, maxCo2: 120, rate: 65.15 },
        { minCo2: 121, maxCo2: 180, rate: 97.63 },
        { minCo2: 181, maxCo2: 250, rate: 212.04 },
        { minCo2: 251, maxCo2: Infinity, rate: 363.25 },
      ],
      co2RatesWLTP: [
        { minCo2: 0, maxCo2: 140, rate: 65.15 },
        { minCo2: 141, maxCo2: 205, rate: 97.63 },
        { minCo2: 206, maxCo2: 260, rate: 212.04 },
        { minCo2: 261, maxCo2: Infinity, rate: 363.25 },
      ],
      additionalCo2RatesPost2017: [
        // Estrutura separada para valores adicionais de CO2
        // Valores exatos ainda precisam de confirmação
        { minCo2: 0, maxCo2: 100, rate: 0.00 },
        { minCo2: 101, maxCo2: 150, rate: 0.00 }, // Valor a confirmar
        { minCo2: 151, maxCo2: 200, rate: 0.00 }, // Valor a confirmar
        { minCo2: 201, maxCo2: 250, rate: 0.00 }, // Valor a confirmar
        { minCo2: 251, maxCo2: Infinity, rate: 0.00 }, // Valor a confirmar
      ],
      dieselSurcharge: [
        { minCc: 0, maxCc: 1250, surcharge: 5.02 },
        { minCc: 1251, maxCc: 1750, surcharge: 10.07 },
    ...
    E: {
      baseRates: [
        { minCc: 0, maxCc: 125, rate: 6.19 }, // 120 to 250 cc = 6.19 €
        { minCc: 126, maxCc: 250, rate: 8.76 }, // >250 to 350 cc = 8.76 €
        { minCc: 251, maxCc: 350, rate: 21.18 }, // >350 to 500 cc = 21.18 €
        { minCc: 351, maxCc: 500, rate: 63.62 }, // >500 to 750 cc = 63.62 €
        { minCc: 501, maxCc: 750, rate: 63.62 }, // >500 to 750 cc = 63.62 €
        { minCc: 751, maxCc: Infinity, rate: 138.15 }, // >750 cc = 138.15 €
      ],
      co2Rates: [
        { minCo2: 0, maxCo2: 100, rate: 0.00 }, // No CO2 component for Category E
        { minCo2: 101, maxCo2: 150, rate: 0.00 },
        { minCo2: 151, maxCo2: 200, rate: 0.00 },
        { minCo2: 201, maxCo2: 250, rate: 0.00 },
        { minCo2: 251, maxCo2: 300, rate: 0.00 },
        { minCo2: 301, maxCo2: Infinity, rate: 0.00 },
      ],
      dieselSurcharge: [
        { minCc: 0, maxCc: 1500, surcharge: 0.00 }, // No diesel surcharge for Category E
        { minCc: 1501, maxCc: 2000, surcharge: 0.00 },
        { minCc: 2001, maxCc: 3000, surcharge: 0.00 },
        { minCc: 3001, maxCc: Infinity, surcharge: 0.00 },
      ],
      registrationYearCoefficients: [
        { minYear: 1996, maxYear: Infinity, coefficient: 1.00 }, // No coefficient for Category E
      ],
    },
  },
...
// IUC Tables for 2024 (older rates)
export const IUC_TABLES_2024 = {
  categories: {
    A: {
      baseRates: [
        { minCc: 0, maxCc: 1000, rate: 19.90 },
