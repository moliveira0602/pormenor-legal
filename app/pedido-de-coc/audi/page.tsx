...
export const metadata = {
  title: "Pedido de COC Audi | Pormenor",
};

export default function MarcaAudi() {
  return (
      ...
      <section className="bg-[var(--navy)] text-white py-16 px-6">
        <div className="max-w-[1100px] mx-auto">
          <div className="flex items-center gap-4">
            <BrandLogo slug="audi" alt="Audi" height={48} />
            <h1 className="font-display font-extrabold text-4xl tracking-tight">COC — Audi</h1>
          </div>
          <p className="text-white/70 mt-3 max-w-2xl">
            Pedido de Certificado de Conformidade Audi com tratamento de toda a documentação.
          </p>
      ...
      <section className="py-14 px-6">
        <div className="max-w-[1100px] mx-auto">
          <p className="text-muted leading-relaxed">
            Para orçamento, indique matrícula (se existir), VIN, ano e combustível.
          </p>
        </div>
      </section>
